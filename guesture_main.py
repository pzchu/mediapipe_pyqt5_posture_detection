...
from guesture_ui import GestureRecognitionUI
...
class GestureRecognitionApp:
    def __init__(self):
        ...
        # 连接信号和槽
        self.ui.open_camera_btn.clicked.connect(self.start_camera)
        self.ui.close_camera_btn.clicked.connect(self.stop_camera)
